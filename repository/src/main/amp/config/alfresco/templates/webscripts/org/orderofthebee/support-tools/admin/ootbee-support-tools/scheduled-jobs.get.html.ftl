                ...
                <tbody>
                    ...
                    <#list jobTriggers as trigger>
                        <tr id="${trigger.triggerName?html}">
                            ...
                            <td id="triggerState">${stateMessages[trigger.triggerState + 1]?html}</td>
                            <td id="jobName">${trigger.jobName?html}</td>
